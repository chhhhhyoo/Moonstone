...
1. FETCH & PARSE:
   - If PR number given: `gh pr view <id> --comments`
   - If text pasted: Read carefully
   - List actionable items (Item 1, Item 2...)
...
5. EVALUATE: Technically sound for THIS codebase?
   - **Synergy**: If feedback suggests a major change (A vs B), activate `tech-decision` to objectively compare the suggestion with the current implementation.
