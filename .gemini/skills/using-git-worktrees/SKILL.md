...
### 1a. Branch Naming Convention (MANDATORY)

**Rule:** Branch names must follow the pattern: `feature/COMMSVC-<TICKET_NUM>-<description>`

**Before creating the branch:**
1.  Ask the user for the Jira Ticket Number (e.g., "653").
2.  Ask for a short description (e.g., "login-page").
3.  Construct the branch name: `feature/COMMSVC-653-login-page`.
