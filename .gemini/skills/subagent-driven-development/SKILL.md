...
## The Process (Persona Shifting)

Since dedicated sub-agents for implementation do not exist, you will **Shift Personas** to simulate this workflow.

### 1. The Controller (You)
*   Read the plan.
*   Extract the next task.
*   Create `todo.md` to track state.

### 2. The Implementer Persona
**Instruction:** "I am now acting as the Implementer. My goal is to pass the tests for Task X."
*   Follow TDD.
*   Write Code.
*   Self-Verify.

### 3. The Spec Reviewer Persona
**Instruction:** "I am now acting as the Spec Reviewer. I will audit the code against the requirements."
*   Read `SPEC.md` or Plan.
*   Read the new code.
*   Verdict: Pass/Fail.

### 4. The Code Quality Persona
**Instruction:** "I am now acting as the Quality Reviewer."
*   Run lint.
*   Check for "smells".
*   Verdict: Pass/Fail.

### Loop
*   If Reviewer fails -> Shift back to Implementer to fix.
*   If Pass -> Controller picks next task.
