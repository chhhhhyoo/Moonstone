...
| PF-POC-019 | Role-based direction anchors and node-id-free mutation planning | in_progress | core | 2026-Q2 | PF-POC-018 | Pilot accepts bounded node-id-free chef directions via deterministic role-based node anchor inference and retains fail-closed proposal-confirm semantics |
