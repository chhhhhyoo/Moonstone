...
| PF-POC-010 | Resume CLI and crash-recovery operator qualification | in_progress | core | 2026-Q2 | PF-POC-009 | `poc:resume` recovery flow proves deterministic crash-to-recovery operator behavior and strict-gate evidence is green |
