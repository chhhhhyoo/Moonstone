...
| PF-POC-015 | Lead-chef SSOT and direct-apply prompt mutation loop | in_progress | core | 2026-Q2 | PF-POC-014 | Prompt-driven single-operation workflow mutations apply deterministically to new artifacts, remain replay/inspect-safe, and are qualified under strict gates |
