...
| PF-POC-004 | Compiler diagnostics and prompt-contract guardrails | in_progress | core | 2026-Q2 | PF-POC-003 | `poc:compile` emits deterministic diagnostics for inferred/fallback behavior and strict verification confirms diagnostic contract stability |
