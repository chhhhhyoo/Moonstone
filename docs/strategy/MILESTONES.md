...
| PF-POC-010 | Resume CLI and crash-recovery operator qualification | planned | core | 2026-Q2 | PF-POC-009 | `poc:resume` recovery flow proves deterministic crash-to-recovery operator behavior and strict-gate evidence is green |
| PF-POC-011 | Promptable tool-blueprint pilot qualification | in_progress | core | 2026-Q2 | PF-POC-009 | Prompt-driven pilot outputs explicit deterministic tool blueprints and executes end-to-end with strict verification evidence |
