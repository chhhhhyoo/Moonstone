...
| PF-POC-014 | Upstream-status conditional routing for prompt-synthesized workflows | in_progress | core | 2026-Q2 | PF-POC-013 | Prompts that express status-based branching compile into deterministic upstream-condition routes and execute with strict qualification evidence |
