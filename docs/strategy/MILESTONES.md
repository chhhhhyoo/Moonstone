...
| PF-POC-017 | Intent-level chef direction to mutation proposal loop | in_progress | core | 2026-Q2 | PF-POC-016 | Pilot accepts high-level feedback intent (without explicit mutation verb), emits deterministic proposed mutation plan with rationale, and applies it safely when confirmed |
