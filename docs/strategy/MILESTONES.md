...
| PF-POC-009 | Webhook ingress E2E qualification and deterministic run-id contract | in_progress | core | 2026-Q2 | PF-POC-008 | Webhook-triggered runs are health-checked, run-id deterministic when header is provided, replay/inspect consistent, and strict-gate backed |
