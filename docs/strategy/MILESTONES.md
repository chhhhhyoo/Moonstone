...
| PF-POC-018 | Intent operation-pack expansion and proposal diff qualification | in_progress | core | 2026-Q2 | PF-POC-017 | Pilot accepts bounded intent directions across add/replace/connect/remove operations, emits deterministic proposal diffs, and keeps apply-confirm flow strict-gate qualified |
