...
| PF-POC-002 | Durable replay hardening for command/receipt execution | in_progress | core | 2026-Q2 | PF-POC-001 | Crash-injected run can resume from append-only journal across command, receipt, retry scheduling, and fan-out continuation windows without duplicate side effects |
