...
| PF-POC-007 | Fault-injection runtime matrix and recovery qualification | in_progress | core | 2026-Q2 | PF-POC-006 | Fault-injected fixture runs recover or fail with expected deterministic outcomes across retry/failure paths under strict verification |
