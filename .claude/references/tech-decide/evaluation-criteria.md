...
Reference for `/tech-decide` — recommended evaluation criteria by decision type.
...
Learning Curve: 30%, Ecosystem: 25%, Documentation: 20%, Performance: 15%, Maintainability: 10%

**Enterprise (Focus on stability)**:
Maintainability: 30%, Type Support: 20%, Community: 20%, Performance: 15%, Documentation: 15%
...
**Early Startup (MVP)**: Dev Speed: 35%, Complexity: 25%, OpEx: 20%, Scalability: 10%, Other: 10%

**Growth Stage (Scale-up)**: Scalability: 30%, Fault Isolation: 20%, Team Fit: 20%, Deployment: 15%, OpEx: 15%
...
|-----------|---------------|
| "Need MVP Fast" | Learning Curve > Dev Speed > Documentation > Rest |
| "Expect Massive Traffic" | Performance > Scalability > OpEx > Rest |
| "Small Team (1-3)" | Low Complexity > Documentation > Community > Rest |
| "Enterprise Environment" | Security > Maintainability > Type Support > Rest |
| "Legacy Integration" | Compatibility > Migration Ease > Rest |
