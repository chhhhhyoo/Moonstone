---
name: save-ref
description: Use when encountering a useful URL, article, paper, or reference worth saving for future sessions. Categorizes and persists to the knowledge base.
user-invocable: true
