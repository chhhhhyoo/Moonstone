---
name: bridge
description: Use for knowledge base operations — retrieve prior knowledge from memory, log session findings to daily notes, or search across project documentation.
user-invocable: true
