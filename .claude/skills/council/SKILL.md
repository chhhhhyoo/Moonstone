---
name: council
description: Use for complex decisions needing multiple expert perspectives. Multi-AI federated council with parallel agents, debate, and synthesis. Triggered by "summon the council" or need for diverse viewpoints.
user-invocable: true
context: fork
allowed-tools: Read, Glob, Grep, Bash, Agent, WebSearch, AskUserQuestion, TaskCreate
---
