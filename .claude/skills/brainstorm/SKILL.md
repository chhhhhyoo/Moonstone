---
name: brainstorm
description: Use for open-ended design exploration, generating multiple approaches, or multi-perspective analysis. Triggered by "brainstorm", "explore options", "design X", or open-ended feature requests.
user-invocable: true
allowed-tools: Read, Glob, Grep, Bash, Agent, WebSearch, AskUserQuestion
---
