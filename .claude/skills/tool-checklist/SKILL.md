---
name: tool-checklist
description: Use when designing or modifying tool definitions. Validates token efficiency, type safety, explicit intent, and safety levers via design principles and validation script.
user-invocable: true
