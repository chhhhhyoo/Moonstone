---
name: verify
description: Use to run the full verification suite — spec lint, conformance, SSOT, module parity, and Moonstone checks. Standard gate before claiming work complete.
user-invocable: true
