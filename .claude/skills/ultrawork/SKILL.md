---
name: ultrawork
description: Use when zero drift and maximum reliability are required. Drift-proof DAG execution with mechanical verification and strict task state management. No hallucination mode.
user-invocable: true
