---
name: clarify
description: Use when requirements are ambiguous, vague, or incomplete. Socratic questioning to resolve intent before taking action. Triggered by unclear asks or "what do you mean by X".
user-invocable: true
