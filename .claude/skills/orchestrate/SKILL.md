---
name: orchestrate
description: Use as master workflow router when starting complex sessions, facing unclear direction, or when the right workflow is uncertain. Routes to epistemic protocol, strategy, or execution as appropriate.
user-invocable: true
allowed-tools: Read, Glob, Grep, Bash, Agent, WebSearch, AskUserQuestion, TaskCreate, TaskUpdate, TaskList
---
