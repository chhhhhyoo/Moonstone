---
name: doubt
description: Use to self-verify claims against evidence before asserting them. Checks facts, file states, and assumptions. Prevents hallucination of success or file existence.
user-invocable: true
