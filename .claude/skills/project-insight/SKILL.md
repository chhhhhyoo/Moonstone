...
description: Use to understand project history, planning context, or current state. Analyzes git history, planning documents, and decision records to surface context.
user-invocable: true
