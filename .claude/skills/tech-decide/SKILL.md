---
name: tech-decide
description: Use for A-vs-B technical decisions, library selection, or architecture choices. Deep parallel research with conclusion-first report. Triggered by "should I use X or Y", "X vs Y", or tech comparisons.
user-invocable: true
context: fork
