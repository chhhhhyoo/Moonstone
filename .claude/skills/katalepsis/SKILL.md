---
name: katalepsis
description: Use after explaining complex concepts, plans, or decisions to verify the user's comprehension. Socratic questioning to confirm understanding before proceeding.
user-invocable: true
