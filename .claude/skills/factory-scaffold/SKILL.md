...
description: Use when creating a new Factory artifact (Tool, Skill, or Agent) from scratch. Spec-first scaffolding with blueprint approval before any code is written.
user-invocable: true
