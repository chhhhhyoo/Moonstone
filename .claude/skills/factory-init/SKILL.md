---
name: factory-init
description: Use when starting a new project phase or complex feature. Scaffolds Manus-style planning files (task_plan.md, findings.md, progress.md) for persistent working memory.
user-invocable: true
