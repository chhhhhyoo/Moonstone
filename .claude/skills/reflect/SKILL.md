---
name: reflect
description: Use at session end or after significant work. 3-agent parallel insight extraction and crystallization of tacit knowledge into persistent memory files.
user-invocable: true
context: fork
