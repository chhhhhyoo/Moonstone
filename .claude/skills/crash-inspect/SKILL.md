---
name: crash-inspect
description: Use for production incidents, crashes, or stack traces. NTSB-style systematic crash documentation and root cause analysis with timeline reconstruction.
user-invocable: true
